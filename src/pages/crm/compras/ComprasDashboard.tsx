        ...
        <div className="space-y-6">
            <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex gap-2 items-center">
                    ...
                    <Button onClick={() => window.location.href = "/crm/compras/operacoes"} variant="outline" className="gap-2 border-orange-200 hover:border-orange-300 bg-orange-50/30 text-orange-700">
                ...
                <TabsContent value="contracts">
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>Gerencie as solicitações e contratos do departamento de Compras</CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid gap-4 md:grid-cols-2">
                                ...
                                <Button
                                    onClick={() => window.location.href = "/crm/compras/contratos"}
            ...
            <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
                ...
                <Card className="hover:shadow-md transition-shadow cursor-pointer border-orange-100 bg-orange-50/10" onClick={() => window.location.href = "/crm/compras/operacoes"}>
                    <CardHeader>
                        <CardTitle className="flex items-center gap-2">
