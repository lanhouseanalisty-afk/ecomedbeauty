...
const categoryImages: Record<string, string> = {
  ...
  Preenchimentos: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?w=400&h=300&fit=crop",
...
export function CategoriesSection() {
  ...
  const displayCategories = categoriesData?.filter((c) => c.id !== "all") || [];

  if (isLoading) {
    return (
      <section className="py-16 lg:py-24">
        <div className="mx-auto max-w-7xl px-4 lg:px-8 flex justify-center py-12">
        ...
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4 lg:gap-6">
          {displayCategories.map((category, index) => (
            ...
            >
              {/* Image */}
              <img
                src={categoryImages[category.name] || categoryImages["Skincare"]}
                alt={category.name}
