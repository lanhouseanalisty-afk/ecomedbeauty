...
const formSchema = z.object({
    ...
    approver_id: z.string().min(1, "Selecione um gestor aprovador"),
                    ...
                    <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="space-y-4">
                            ...
                            <FormField
                                ...
                                render={({ field }) => (
                                    <FormItem>
                                        <FormLabel className="text-slate-300">Gestor Aprovador *</FormLabel>
                                        <select
                                            {...field}
                                            onChange={(e) => {
                                                ...
                                                if (selectedManager) {
                                                    form.setValue('approver_name', selectedManager.full_name || '');
                                                }
                                            }}
                                            className="flex h-10 w-full rounded-md border border-slate-700 bg-slate-800 px-3 py-2 text-sm text-white ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                                        >
                                        ...
                                        <p className="text-xs text-slate-400 mt-1">
                                            Este gestor receberá e aprovará sua solicitação
                                        </p>
                                        <FormMessage />
                                    </FormItem>
                                )}
