...
import DocuSignPage from "./pages/crm/DocuSignPage";
              ...
              <BrowserRouter>
                <Routes>
                  ...
                  <Route path="/crm" element={
                    ...
                    <Route path="admin/docusign" element={
                      <ProtectedRoute requiredModule="admin">
                        <DocuSignPage />
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="rh/docusign" element={
                      <ProtectedRoute requiredModule="rh">
                        <DocuSignPage />
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="financeiro/docusign" element={
                      <ProtectedRoute requiredModule="financeiro">
                        <DocuSignPage />
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="comercial/docusign" element={
                      <ProtectedRoute requiredModule="comercial">
                        <DocuSignPage />
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="juridico/docusign" element={
                      <ProtectedRoute requiredModule="juridico">
                        <DocuSignPage />
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="tech/docusign" element={
                      <ProtectedRoute requiredModule="tech">
                        <DocuSignPage />
                      </ProtectedRoute>
                    } />
                    ...
                    <Route path="ecommerce/docusign" element={
                      <ProtectedRoute requiredModule="ecommerce">
                        <DocuSignPage />
                      </ProtectedRoute>
                    } />
