  ...
  public: {
    Tables: {
      ...
      ecommerce_carts: {
        ...
        Relationships: [
          {
            foreignKeyName: "ecommerce_carts_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: true
      ...
      ecommerce_search_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "ecommerce_search_history_customer_id_fkey"
            columns: ["customer_id"]
            isOneToOne: false
            referencedRelation: "ecommerce_customers"
            referencedColumns: ["id"]
      ...
      employee_post_comments: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_post_comments_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "employee_posts"
            referencedColumns: ["id"]
          },
        ]
      }
      employee_post_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_post_likes_post_id_fkey"
            columns: ["post_id"]
            isOneToOne: false
            referencedRelation: "employee_posts"
            referencedColumns: ["id"]
      ...
      employee_posts: {
        ...
        Relationships: [
          {
            foreignKeyName: "employee_posts_employee_id_fkey"
            columns: ["employee_id"]
            isOneToOne: false
            referencedRelation: "employees"
            referencedColumns: ["id"]
      ...
      marketing_requests: {
        Row: {
          ...
          bonus_order_number: string | null
          cep: string
          city: string
      ...
      tech_asset_history: {
        ...
        Relationships: [
          {
            foreignKeyName: "tech_asset_history_asset_id_fkey"
            columns: ["asset_id"]
            isOneToOne: false
      ...
      tech_assets: {
        Row: {
          ...
          brand: string
          created_at: string | null
          device_type: Database["public"]["Enums"]["tech_device_type"]
          id: string
          location: string | null
          model: string
          modified_after_admission: boolean | null
          notes: string | null
          purchase_date: string | null
          serial_number: string | null
          specifications: Json | null
          status: Database["public"]["Enums"]["tech_asset_status"] | null
          updated_at: string | null
      ...
      termination_notifications: {
        Row: {
          ...
          target_email: string | null
          target_step: string
          termination_process_id: string | null
        }
        Insert: {
          created_at?: string | null
          id?: string
        ...
        Relationships: [
          {
            foreignKeyName: "termination_notifications_termination_process_id_fkey"
            columns: ["termination_process_id"]
            isOneToOne: false
      ...
      termination_processes: {
        Row: {
          ...
          equipment_returned: string | null
      ...
      tickets: {
        ...
        Relationships: [
          {
            foreignKeyName: "fk_tickets_requester_profile"
