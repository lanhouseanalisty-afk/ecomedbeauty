-- =====================================================
-- LIMPAR TUDO E CRIAR USUÁRIO NOVO
-- Execute este script no SQL Editor do projeto NOVO
-- =====================================================

-- 1. Deletar TUDO relacionado ao email (na ordem correta)
DELETE FROM public.user_roles 
WHERE user_id IN (SELECT id FROM auth.users WHERE email = 'reginaldo.mazaro@medbeauty.com.br');

DELETE FROM public.profiles 
WHERE id IN (SELECT id FROM auth.users WHERE email = 'reginaldo.mazaro@medbeauty.com.br');
